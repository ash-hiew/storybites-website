...
export default function PrivacyPolicy() {
  return (
    <Layout>
      <article className='px-10 prose prose-zinc prose-sm md:prose-base mx-auto max-w-3xl'>
      ...
      <section className='font-primary'>
        ...
        <p>This policy is effective as of 26 April 2022 and was last updated on 26 April 2022. </p>
      </section>

      <section className='space-y-4 font-primary my-5'>
        <h3 className='font-semibold text-xl md:text-3xl'>Information We Collect</h3>
        ...
        <div className='space-y-2'>
          <h4 className='font-semibold text-l md:text-xl'>Log Data</h4>
        ...
        <div className='space-y-2'>
          <h4 className='font-semibold text-l md:text-xl'>Personal Information</h4>
        ...
        <div className='space-y-2'>
          <h4 className='font-semibold text-l md:text-xl'>Legitimate Reasons for Processing Your Personal Information</h4>
        ...
        <div className='space-y-2'>
          <h4 className='font-semibold text-l md:text-xl'>Collection and Use of Information</h4>
        ...
        <div className='space-y-2'>
          <h4 className='font-semibold text-l md:text-xl'>Security of Your Personal Information</h4>
        ...
        <div className='space-y-2'>
          <h4 className='font-semibold text-l md:text-xl'>How Long We Keep Your Personal Information</h4>
      ...
      <section className='space-y-5 font-primary my-5'>
        <h3 className='font-semibold text-xl md:text-3xl'>Children’s Privacy</h3>
      ...
      <section className='space-y-5 font-primary my-5'>
        <h3 className='font-semibold text-xl md:text-3xl'>International Transfers of Personal Information</h3>
      ...
      <section className='space-y-5 font-primary my-5'>
        <h3 className='font-semibold text-xl md:text-3xl'>Your Rights and Controlling Your Personal Information</h3>
      ...
      <section className='space-y-5 font-primary my-5'>
        <h3 className='font-semibold text-xl md:text-3xl'>Use of Cookies</h3>
      ...
      <section className='space-y-5 font-primary my-5'>
        <h3 className='font-semibold text-xl md:text-3xl'>Limits of Our Policy</h3>
        <p>Our website may link to external sites that are not operated by us.Please be aware that we have no control over the content and policies of those sites, and cannot accept responsibility or liability for their respective privacy practices.</p>
      </section>

      <section className='space-y-5 font-primary my-5'>
        <h3 className='font-semibold text-xl md:text-3xl'>Changes to This Policy</h3>
      ...
      <section className='space-y-5 font-primary my-5'>
        <h3 className='font-semibold text-xl md:text-3xl'>Contact Us</h3>
        <p>For any questions or concerns regarding your privacy, you may contact us using the following details: </p>
        <p><span className='font-semibold'>Justin Yau</span><br />
        https://www.storybites.co.nz<br/>
        hello@storybites.co.nz</p>
      </section>
      </article>
      </Layout>
  )
