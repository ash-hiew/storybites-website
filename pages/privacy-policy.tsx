...
export default function PrivacyPolicy() {
  return (
    <Layout>
      ...
      />
      <main>
        <article className="prose prose-sm prose-zinc mx-auto my-10 max-w-3xl px-10 md:prose-base">
          <h1 className="font-display text-4xl font-bold sm:text-5xl md:text-6xl">
            Privacy Policy
          </h1>
          <section className="font-primary">
            <p>
              Your privacy is important to us. It is Storybites&#39; policy to
              ...
              <a
                ...
                href="https://storybites.co.nz"
              >
                https://storybites.co.nz
              </a>
              .
            </p>
            <p>
              This policy is effective as of 26 April 2022 and was last updated
              on 26 April 2022.{" "}
            </p>
          </section>

          <section className="my-5 space-y-4 font-primary">
            ...
            <div className="space-y-2">
              <h3 className="text-l font-semibold md:text-xl">Log Data</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="text-l font-semibold md:text-xl">
              ...
              <ul className="my-2 list-outside list-disc pl-10">
                <li>Name</li>
                <li>Email</li>
          ...
          <section className="my-5 space-y-5 font-primary">
            <h2 className="text-xl font-semibold md:text-3xl">
              Children’s Privacy
            </h2>
            <p>
          ...
          <section className="my-5 space-y-5 font-primary">
            ...
            <p>
              ...
              maintain facilities.Please be aware that the locations to which we
              store, process, or transfer your personal information may not have
          ...
          <section className="my-5 space-y-5 font-primary">
            <h3 className="text-xl font-semibold md:text-3xl">Contact Us</h3>
            <p>
              For any questions or concerns regarding your privacy, you may
              contact us using the following details:{" "}
            </p>
            <p>
              <span className="font-semibold">Justin Yau</span>
              <br />
              https://www.storybites.co.nz
              <br />
              hello@storybites.co.nz
            </p>
          </section>
        </article>
      </main>
