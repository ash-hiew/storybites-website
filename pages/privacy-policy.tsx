    ...
    <Layout>
      ...
      <main>
        ...
        <section className='space-y-4 font-primary my-5'>
          <h2 className='font-semibold text-xl md:text-3xl'>Information We Collect</h2>
          ...
          <div className='space-y-2'>
            <h3 className='font-semibold text-l md:text-xl'>Log Data</h3>
          ...
          <div className='space-y-2'>
            <h3 className='font-semibold text-l md:text-xl'>Personal Information</h3>
          ...
          <div className='space-y-2'>
            <h3 className='font-semibold text-l md:text-xl'>Legitimate Reasons for Processing Your Personal Information</h3>
          ...
          <div className='space-y-2'>
            <h3 className='font-semibold text-l md:text-xl'>Collection and Use of Information</h3>
          ...
          <div className='space-y-2'>
            <h3 className='font-semibold text-l md:text-xl'>Security of Your Personal Information</h3>
          ...
          <div className='space-y-2'>
            <h3 className='font-semibold text-l md:text-xl'>How Long We Keep Your Personal Information</h3>
        ...
        <section className='space-y-5 font-primary my-5'>
          <h2 className='font-semibold text-xl md:text-3xl'>Children’s Privacy</h2>
        ...
        <section className='space-y-5 font-primary my-5'>
          <h2 className='font-semibold text-xl md:text-3xl'>International Transfers of Personal Information</h2>
        ...
        <section className='space-y-5 font-primary my-5'>
          <h2 className='font-semibold text-xl md:text-3xl'>Your Rights and Controlling Your Personal Information</h2>
        ...
        <section className='space-y-5 font-primary my-5'>
          <h2 className='font-semibold text-xl md:text-3xl'>Use of Cookies</h2>
        ...
        <section className='space-y-5 font-primary my-5'>
          <h2 className='font-semibold text-xl md:text-3xl'>Limits of Our Policy</h2>
          <p>Our website may link to external sites that are not operated by us.Please be aware that we have no control over the content and policies of those sites, and cannot accept responsibility or liability for their respective privacy practices.</p>
        </section>

        <section className='space-y-5 font-primary my-5'>
          <h2 className='font-semibold text-xl md:text-3xl'>Changes to This Policy</h2>
