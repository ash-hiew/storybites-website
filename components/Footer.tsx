      ...
      <div className="mx-auto flex max-w-screen-xl flex-col justify-between space-y-20 px-4 pb-0 pt-5 text-zinc-50 sm:p-6 lg:flex-row lg:items-end lg:space-x-20 lg:space-y-5">
        ...
        <div className="flex-end mx-auto flex flex-col items-center space-y-4 lg:items-end">
          ...
          <div className="mt-2 flex justify-end space-x-4 prose-a:text-zinc-400 prose-a:transition-all prose-a:duration-300 hover:prose-a:text-zinc-50">
            ...
            <a href={siteMetadata.spotify} className="text-stone-400">
              ...
              >
                <path
                  fillRule="evenodd"
                  d="M19.94,0C8.93,0,0,8.93,0,19.94s8.93,19.94,19.94,19.94,19.94-8.93,19.94-19.94S30.94,0,19.94,0ZM28.03,29.33c-.34,0-.55-.1-.86-.29-5.02-3.02-10.85-3.15-16.62-1.97-.31.08-.72.21-.96.21-.78,0-1.27-.62-1.27-1.27,0-.83.49-1.22,1.09-1.35,6.58-1.46,13.31-1.33,19.05,2.11.49.31.78.59.78,1.33s-.57,1.24-1.22,1.24ZM30.19,24.06c-.42,0-.7-.18-.99-.34-5.02-2.97-12.52-4.17-19.18-2.36-.39.1-.59.21-.96.21-.86,0-1.56-.7-1.56-1.56s.42-1.43,1.25-1.66c2.23-.63,4.52-1.09,7.86-1.09,5.22,0,10.26,1.29,14.23,3.66.65.39.91.88.91,1.58,0,.87-.68,1.57-1.56,1.57ZM32.69,17.93c-.42,0-.68-.1-1.04-.31-5.72-3.42-15.96-4.24-22.58-2.39-.29.08-.65.21-1.04.21-1.06,0-1.87-.83-1.87-1.9s.68-1.71,1.4-1.92c2.83-.83,6-1.22,9.45-1.22,5.87,0,12.02,1.22,16.51,3.84.63.36,1.04.86,1.04,1.82,0,1.09-.88,1.87-1.87,1.87Z"
                />
              </svg>
            </a>
          </div>
