    ...
    <div className="flex flex-col flex-grow lg:items-center mx-10 md:mx-18">
      ...
      <div className="flex flex-col items-center lg:items-end space-y-4 mx-auto">
        ...
        <div className="flex mt-2 space-x-4 justify-end">
          <a href="https://www.instagram.com/storybites._/" target="_blank" className="text-zinc-400 hover:text-zinc-50 duration-500 transition-all">
          ...
          <a href="https://www.youtube.com/channel/UCuAccpHzrizN1kln0_oGYRQ" target="_blank" className="text-zinc-400 hover:text-zinc-50 duration-500 transition-all">
