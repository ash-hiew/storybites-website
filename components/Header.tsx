...
function Header() {
  ...
  return (
    <header className="font-primary sticky top-0 z-50 shadow-md bg-gray-50">
      ...
      } fixed bottom-20 flex flex-col items-start p-8 space-y-4 mx-auto lg:hidden prose-a:transition-all prose-a:duration-300 prose-a:ease-in-out hover:prose-a:text-black`}>
