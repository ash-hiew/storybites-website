...
function Header() {
  ...
  return (
    <header className="font-primary sticky top-0 z-50 shadow-md bg-gray-50">

      <nav className='flex max-w-7xl mx-auto relative items-center flex-wrap bg-gray-50 p-3'>
        ...
        <button
          className=' inline-flex lg:hidden text-black ml-auto outline-none hover:scale-90 transition-all duration-300 z-20'
          onClick={handleClick}
        >
        ...
        >
          <div className='p-5 mt-32 text-3xl font-bold space-y-5 lg:inline-flex lg:flex-row lg:ml-auto lg:w-auto lg:p-0 lg:mt-0 lg:space-y-0 w-full lg:items-center flex flex-col lg:text-base lg:font-medium lg:h-auto transition-all duration-300 ease-in-out'>
            ...
            <Link href='/contact'>
              <a className={`${ active ? 'text-opacity-100' : 'text-opacity-0 ' } transition-all duration-300 ease-in-out lg:inline-flex lg:w-auto w-full px-3 py-2 rounded text-black items-center justify-center lg:text-opacity-100 hover:scale-105 hover:text-yellow-500`}>
                Work with Us
              </a>
            </Link>
          </div>
      ...
      <div className={`${
      ...
      } fixed bottom-20 transition-all duration-300 ease-in-out flex flex-col items-start p-8 space-y-4 mx-auto lg:hidden`}>
        ...
        <div className="flex mt-3 space-x-4 justify-end">
          <a href="#" className="text-gray-400 hover:text-black">
            ...
            <svg className="w-8 h-8 transition-all duration-300" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a href="#" className="text-gray-400 hover:text-black">
            ...
            <svg className="w-9 h-9 transition-all duration-300" aria-hidden="true" fill="currentColor" viewBox="0 3 50 50"><path fillRule="evenodd" d="M 44.898438 14.5 C 44.5 12.300781 42.601563 10.699219 40.398438 10.199219 C 37.101563 9.5 31 9 24.398438 9 C 17.800781 9 11.601563 9.5 8.300781 10.199219 C 6.101563 10.699219 4.199219 12.199219 3.800781 14.5 C 3.398438 17 3 20.5 3 25 C 3 29.5 3.398438 33 3.898438 35.5 C 4.300781 37.699219 6.199219 39.300781 8.398438 39.800781 C 11.898438 40.5 17.898438 41 24.5 41 C 31.101563 41 37.101563 40.5 40.601563 39.800781 C 42.800781 39.300781 44.699219 37.800781 45.101563 35.5 C 45.5 33 46 29.398438 46.101563 25 C 45.898438 20.5 45.398438 17 44.898438 14.5 Z M 19 32 L 19 18 L 31.199219 25 Z"/></svg>
          </a>
        </div>
      </div>
    </header>
